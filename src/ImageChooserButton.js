...
// TODO: replace this with real gettext.
const _ = text => text
...
export function registerImageChooserButton() {
  if (GObject.type_from_name('PanelImageBackgroundImageChooserButton') == null) {
    GObject.registerClass(
      {
        GTypeName: 'PanelImageBackgroundImageChooserButton',
      ...
      class PanelImageBackgroundImageChooserButton extends Gtk.Box {  // --------------------------
        _init(params = {}) {
          super._init(params);
        ...
        set file(value) {
          ...
          if (this._file.query_exists(null)) {
            ...
            this._file        = null;
					...
					this.set_tooltip_text(this._file.get_path())
          this.notify('file');
        }
      });
  }
